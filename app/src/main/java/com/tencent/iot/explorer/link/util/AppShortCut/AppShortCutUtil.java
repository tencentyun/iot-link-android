package com.tencent.iot.explorer.link.util.AppShortCut;
...
byte[] bytes = new byte[100];
    ...
    private static void installRawShortCut(Context context, Class<?> clazz, String appName, boolean isShowNum, String num, boolean isStroke) {
...
//                    generatorNumIcon4(
//                            context,
//                            ((BitmapDrawable)context.getResources().getDrawable(R.drawable.app_logo)).getBitmap(),
//                            isShowNum,
//                            num));
        } else {
//            shortcutIntent.putExtra(Intent.EXTRA_SHORTCUT_ICON,
...
//                            num));
     ...
     * @return
     */
    private static boolean isAddShortCut(Context context, String appName) {
        Log.e(TAG, "isAddShortCut....");

        boolean isInstallShortcut = false;
        final ContentResolver cr = context.getContentResolver();

        //注释的代码，在有的手机：修改了ROM的系统，不能支持
     ...
     * @param clazz
     */
    private static void deleteShortCut(Context context, String appName, Class<?> clazz) {
        ...
        if (Build.MANUFACTURER.equalsIgnoreCase("Xiaomi")) {
            ...
            //删除显示数字的快捷方式
            deleteRawShortCut(context, appName, clazz);
            //安装不显示数字的快捷方式
     ...
     * @param clazz 启动的activity
     */
    private static void deleteRawShortCut(Context context, String app_name, Class<?> clazz) {
     ...
     *
     */
    private static void xiaoMiShortCut(Context context, Class<?> clazz, String num) {
     ...
     * @param num
     */
    private static void sonyShortCut(Context context, String num) {
     ...
     * @param num
     */
    private static void samsungShortCut(Context context, String num) {
        int numInt = Integer.valueOf(num);
        if (numInt < 1) {
            num = "0";
        } else if (numInt > 99) {
...
//            installRawShortCut(context, MainActivity.class, isShowNum, num, isStroke);
    ...
    private static ShapeDrawable getDefaultBackground2(Context context) {
        ...
        //圆角矩形
        RoundRectShape rr = new RoundRectShape(outerR, null, null);
        CustomBorderDrawable drawable = new CustomBorderDrawable(rr, DEFAULT_NUM_COLOR, DEFAULT_STROKE_COLOR, distance);
