    ...
    protected synchronized void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mCircleCenterPointPositionList.size(); i++) {
            ...
            if (i >= mComplectingPosition) {
                bitmap = BitmapUtils.createWaterMark(mDefaultIcon, String.valueOf(i), (int)mCircleRadius * 2, mCircleTextSize);
            }  else {
                bitmap = BitmapUtils.createWaterMark(mCompleteIcon, String.valueOf(i), (int)mCircleRadius * 2, mCircleTextSize);
            }
