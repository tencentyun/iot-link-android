...
class HttpRequest private constructor() {
    ...
    init {
        //初始化请求
        StringRequest.instance.init(UNLOGINEDHOST)
    }
    ...
    companion object {
        ...
        const val LOGINEDHOST = "https://iot.cloud.tencent.com/api/"
        const val UNLOGINEDHOST = "https://iot.cloud.tencent.com/api/"
    ...
    private fun postJson(param: HashMap<String, Any>, callback: MyCallback, reqCode: Int) {
        ...
        L.e("api=$api")
        StringRequest.instance.postJson(UNLOGINEDHOST, api, json, object : Callback {
    ...
    fun getRegionList(uri: String, callback: MyCustomCallBack, reqCode: Int) {
        StringRequest.instance.postJson(UNLOGINEDHOST, uri, "", object : Callback {
            override fun fail(msg: String?, reqCode: Int) {
                callback.fail(msg, reqCode)
            }
            override fun success(json: String, reqCode: Int) {
    ...
    private fun tokenPost(param: HashMap<String, Any>, callback: MyCallback, reqCode: Int) {
        ...
        StringRequest.instance.postJson(LOGINEDHOST, api, json, object : Callback {
            override fun fail(msg: String?, reqCode: Int) {
                callback.fail(msg, reqCode)
            }
    ...
    private fun tokenAppCosAuth(param: HashMap<String, Any>, callback: MyCallback, reqCode: Int) {
        ...
        StringRequest.instance.postJson(LOGINEDHOST, APP_COS_AUTH, json, object : Callback {
            override fun fail(msg: String?, reqCode: Int) {
                callback.fail(msg, reqCode)
            }
