...
class SoftAppStepActivity : PActivity() {
    ...
    override fun getContentView(): Int {
        return R.layout.activity_soft_app_step
    }

    private fun refreshTypeView() {
        tv_soft_ap_title.setText(R.string.soft_config_network)
        tip_title.setText(R.string.soft_ap_first_title)
        tv_soft_banner_title.setText(R.string.soft_ap_first_toast)
