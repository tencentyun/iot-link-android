...
import com.tencent.iot.explorer.link.core.utils.Utils.bytesToHexString
    ...
    var data: ByteArray? = null
        set(value) {
            ...
            field?.let {
                ...
                Log.e("XXX", "it.value " + BleConfigService.get().bytesToHex(it))
                val signInfoByteArr = ByteArray(20)
                System.arraycopy(it, 3, signInfoByteArr, 0, 20)
                BleConfigService.get().bytesToHex(signInfoByteArr)?.let { signStr ->
