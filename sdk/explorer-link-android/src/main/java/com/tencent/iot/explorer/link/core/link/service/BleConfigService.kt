...
class BleConfigService private constructor() {
    ...
    var nonceKeep = 0L
    private val WRITEINTERVAL: Long = 100
    @Volatile
    ...
    private var bluetoothGattCallback =  object: BluetoothGattCallback() {
        ...
        override fun onCharacteristicWrite(gatt: BluetoothGatt?, characteristic: BluetoothGattCharacteristic?, status: Int) {
            L.d(TAG, "onCharacteristicWrite gatt:${gatt}, characteristic: ${characteristic}, status：${status}")
        }
