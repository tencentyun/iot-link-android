...
open class VideoBaseService {
    ...
    fun describeDevices(
        ...
        var headerParams = commonHeaderParams("DescribeDevices")
    ...
    open fun sign(
        ...
        val secretDate: ByteArray = hmac256(
                ("TC3" + IoTAuth.SECRETI_KEY).toByteArray(UTF8),
                date
            )
        ...
        return algorithm + " " + "Credential=" + IoTAuth.SECRETI_ID + "/" + credentialScope + ", " + "SignedHeaders=" + signedHeaders + ", " + "Signature=" + signature
    }
