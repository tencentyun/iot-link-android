...
//                Log.e(TAG, "===== dataLen:" + data.size);
    ...
    override fun initView() {
        ...
        XP2P.startService(this@VideoWithoutPropertyActivity, "${App.data.accessInfo!!.productId}/${presenter.getDeviceName()}",
    ...
    private fun keepPlayerplay(id: String?) {
        ...
        Thread{
            ...
            while (true) {
                ...
                Log.d(tag, "====开始尝试重连...")
                XP2P.stopService(id)
                while (XP2P.startService(this@VideoWithoutPropertyActivity, id, App.data.accessInfo!!.productId, presenter.getDeviceName())!=0
