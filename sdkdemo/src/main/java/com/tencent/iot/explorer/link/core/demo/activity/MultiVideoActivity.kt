...
class MultiVideoActivity : BaseActivity(), XP2PCallback {
    ...
    override fun initView() {
        ...
        playerMap[playerClient01.deviceName] = playerClient01
        ...
        playerMap[playerClient02.deviceName] = playerClient02
    ...
    private fun xp2pStartAndPlayThread(xp2p: XP2PCallback, playerClient: playerClient) {
        ...
        object : Thread() {
            override fun run() {
                ...
                if (ret == 0) {
                    avPlay(playerClient, playerClient.deviceName)
                } else {
                    runOnUiThread {
    ...
    private fun avPlay(playerClient: playerClient, deviceName: String) {
    ...
    override fun onDestroy() {
        ...
        XP2P.stopService("$productId/${playerClient01.deviceName}")
        XP2P.stopService("$productId/${playerClient02.deviceName}")
    }
