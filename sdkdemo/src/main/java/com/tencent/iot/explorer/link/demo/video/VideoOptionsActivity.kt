...
import com.tencent.iot.explorer.link.demo.video.preview.RecordVideoActivity
...
class VideoOptionsActivity : VideoBaseActivity() {
    ...
    override fun setListener() {
        ...
        btn_video_collect.setOnClickListener { jumpActivity(RecordVideoActivity::class.java) }
    }
