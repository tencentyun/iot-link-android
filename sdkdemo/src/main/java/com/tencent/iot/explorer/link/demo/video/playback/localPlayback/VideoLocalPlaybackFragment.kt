...
import kotlinx.android.synthetic.main.fragment_video_local_playback.palayback_video
...
//        }
    ...
    private fun refreshDateTime(date: Date) {
        ...
        devInfo?.let {
            setPlayerUrl(Command.getLocalVideoUrl(it.channel, formateDatas[0].startTime.time, formateDatas[0].endTime.time))
        }
    }

    private fun setPlayerUrl(suffix: String) {
        Log.e("XXX", "setPlayerUrl suffix ${suffix}")
        currentPostion = player.duration
