...
class WlanVideoPreviewActivity : VideoBaseActivity(), TextureView.SurfaceTextureListener,
    ...
    companion object {
        fun startPreviewActivity(context: Context?, dev: DevInfo) {
            ...
            val intent = Intent(context, WlanVideoPreviewActivity::class.java)
            val bundle = Bundle()
    ...
    private var switchVideoQualityListener = View.OnClickListener { showVVideoQualityDialog() }
    ...
    private fun showVVideoQualityDialog() {
        ...
        val dlg = ListOptionsDialog(this@WlanVideoPreviewActivity, options)
        dlg.show()
