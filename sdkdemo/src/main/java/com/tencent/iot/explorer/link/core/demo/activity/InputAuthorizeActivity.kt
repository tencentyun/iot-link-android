...
class InputAuthorizeActivity : BaseActivity() {
    ...
    override fun initView() {
        ...
        SharePreferenceUtil.saveString(this, VideoConst.VIDEO_CONFIG, VideoConst.VIDEO_SAVE_RAW_AV, "false")
    ...
    override fun setListener() {
        ...
        tbtn_save_raw_video.setOnCheckedChangeListener { _, isChecked ->
            if (isChecked) {
                SharePreferenceUtil.saveString(this, VideoConst.VIDEO_CONFIG, VideoConst.VIDEO_SAVE_RAW_AV, "true")
            } else {
                SharePreferenceUtil.saveString(this, VideoConst.VIDEO_CONFIG, VideoConst.VIDEO_SAVE_RAW_AV, "false")
            }
        }
