...
import com.tencent.iot.explorer.link.core.demo.response.BindDeviceTokenResponse
import com.tencent.iot.explorer.link.core.demo.response.DeviceBindTokenStateResponse
...
class ConnectDeviceActivity : BaseActivity() {
    ...
    override fun initView() {
        IoTAuth.deviceImpl.getBindDevToken(App.data.userInfo.UserID, object: MyCallback {
