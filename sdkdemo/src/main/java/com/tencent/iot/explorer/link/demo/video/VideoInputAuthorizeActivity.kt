...
class VideoInputAuthorizeActivity : VideoBaseActivity() , CoroutineScope by MainScope() {
    ...
    override fun initView() {
        var a = WlanDetectBody()
        a.clientToken = "xxxx 1"
        a.productId = "pro xx 1"
        a.deviceNames.add("a1")
        a.deviceNames.add("a2")
        a.deviceNames.add("b1")
        DetectService.getInstance().startSendBroadcast(a, 20)
