...
//
//class VideoMultiPreviewActivity : VideoPreviewBaseActivity(), XP2PCallback, CoroutineScope by MainScope() {
...
//        Thread(Runnable {
//            val id = "${App.data.accessInfo!!.productId}/${devName}"
//            XP2P.startService(this@VideoMultiPreviewActivity, id, presenter.getProductId(), devName, xP2PAppConfig)
//            val started =  XP2P.setParamsForXp2pInfo(id,"")
//            // 已经启动过，或者第一次启动，继续进行
//            if (started != 0 && started != -1011) {
//                launch(Dispatchers.Main) {
//                    var errInfo = getString(R.string.error_with_code, id, started.toString())
//                    Toast.makeText(this@VideoMultiPreviewActivity, errInfo, Toast.LENGTH_SHORT)
//                        .show()
//                }
//                return@Runnable
//            }
...
//            countDownLatchs.put(
//                "${App.data.accessInfo!!.productId}/${devName}/${channel}",
//                tmpCountDownLatch
//            )
...
//                                "${it.productId}/${holders.get(i).devName}",
//                                command.toByteArray(),
...
//
//                // 发现断开尝试恢复视频，每隔一秒尝试一次
//                XP2P.startService(this@VideoMultiPreviewActivity, id, presenter.getProductId(), presenter.getDeviceName(), xP2PAppConfig)
//                var flag =  XP2P.setParamsForXp2pInfo(id,"")
...
//                    }
//                    XP2P.startService(this@VideoMultiPreviewActivity, id, presenter.getProductId(), presenter.getDeviceName(), xP2PAppConfig)
//                    flag =  XP2P.setParamsForXp2pInfo(id,"")
//                }
//
...
//                        val url =
//                            urlPrefix + Command.getVideoHightQualityUrlSuffix(playerHolder.channel)
//                        it.reset()
